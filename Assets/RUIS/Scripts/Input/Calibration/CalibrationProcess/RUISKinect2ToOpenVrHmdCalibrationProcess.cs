...
public class RUISKinect2ToOpenVrHmdCalibrationProcess : RUISCalibrationProcess {
...
//	RUISOVRManager ruisOvrManager;
	...
	public RUISKinect2ToOpenVrHmdCalibrationProcess(RUISCalibrationProcessSettings calibrationSettings) {
	...
	public override RUISCalibrationPhase InitialPhase(float deltaTime) {
		...
		if(timeSinceScriptStart < 3) {
			this.guiTextLowerLocal = "Calibration of Kinect 2 and OpenVR\n\n Starting up...";
