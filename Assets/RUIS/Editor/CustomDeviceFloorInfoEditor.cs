...
public class CustomDeviceFloorInfoEditor : Editor
{
    public override void OnInspectorGUI()
    {
		...
		EditorGUILayout.HelpBox("OPTIONAL: If your custom device supports floor detection, add a component that sets this GameObject's "
							...
							+ "left-handed coordinate system.", MessageType.Info);
    }
}
