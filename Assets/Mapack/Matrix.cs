...
//		[CLSCompliant(false)]
		...
		/// <summary>Creates a copy of the matrix.</summary>
		public static void Clone(Matrix src, Matrix dst)
		{
			double[][] u = src.Array;
			double[][] x = dst.Array;
		...
		/// <summary>Returns the transposed matrix.</summary>
		public static void Transpose(Matrix src, Matrix dst)
		{
			double[][] u = src.Array;
			double[][] x = dst.Array;
			...
			if ((src.Rows != dst.Columns) || (src.Columns != dst.Rows))
			{
				throw new ArgumentException("Matrix dimension do not match.");
			}
		...
		/// <summary>Matrix addition.</summary>
		public static void Add(Matrix left, Matrix right, Matrix dst)
		{
			if (left == null)
			{
				throw new ArgumentNullException("left");
			...
			if ((rows != right.Rows) || (columns != right.Columns) || dst.Rows != rows || dst.Columns != columns)
			{
				throw new ArgumentException("Matrix dimension do not match.");
			}
		...
		/// <summary>Matrix subtraction.</summary>
		public static void Subtract(Matrix left, Matrix right, Matrix dst)
		{
			if (left == null)
			{
				throw new ArgumentNullException("left");
		...
		/// <summary>Matrix-scalar multiplication.</summary>
		public static void Multiply(Matrix left, double right, Matrix dst)
		{
			if (left == null)
			{
				throw new ArgumentNullException("left");
			...
			if (left.Rows != dst.Rows || left.Columns != dst.Columns )
			{
		...
		/// <summary>Matrix-matrix multiplication.</summary>
		public static void Multiply(Matrix left, Matrix right, Matrix dst)
		{
			if (left == null)
			{
				throw new ArgumentNullException("left");
			...
			if (right.Rows != left.columns || dst.Rows != left.Rows || dst.Columns != right.Columns)
			{
				throw new ArgumentException("Matrix dimensions are not valid.");
			}
		...
		/// <summary>Returns a diagonal matrix of the given size.</summary>
		public static void Diagonal(int rows, int columns, double value, Matrix dst)
		{
			double[][] x = dst.Array;
			...
			if (rows != dst.Rows || columns != dst.Columns )
			{
				throw new ArgumentException("Matrix dimensions are not valid.");
			}
